...
public class dem {
	...
	public void setDefaultUserDefinedSetting() {
		//setDefaultConfig();
		textField.setText("4");
		textField_1.setText("4");
		textField_2.setText("128");
		textField_3.setText("64");
		textField_11.setText("16");
		textField_10.setText("32");
	...
	public void loadConfig() {
		if (list_1.getSelectedValue() != null) {
			...
			if (chosenConfig.compareTo("User Defined") != 0) {
				setDefaultConfig();
			}
			if (chosenConfig.compareTo("Split reads") == 0) {
			...
			else if (chosenConfig.compareTo("Deadlines") == 0) {
				comboBox_1.setSelectedIndex(1);  // this is the interleaving thing
				comboBox_2.setSelectedIndex(1);
				comboBox_3.setSelectedIndex(0);  // shortest queues
				list.setSelectedIndex(0);  		 // FIFO OS scheduler
				textField_6.setText("4000");
				chckbxLocality.setSelected(false);
				executableName = "interleaving";
				imageLocation = "exp_interleaving/no_split/Global/";
				list_6.setSelectedIndex(0);
				...
				list_6.setSelectedIndex(1);
			}
			else if (chosenConfig.compareTo("File System & Tagging") == 0) {
				comboBox_1.setSelectedIndex(1);  // this is the interleaving thing
				comboBox_2.setSelectedIndex(0);
				comboBox_3.setSelectedIndex(1);  // shortest queues + locality detection
				list.setSelectedIndex(1);  		 // FIFO OS scheduler
				textField_6.setText("none");
			...
			else if (chosenConfig.compareTo("User Defined") == 0) {
				executableName = "user_defined";
				imageLocation = "exp_user_defined/user_defined/Global/";
				workload_id = list_6.getSelectedIndex() + "";
				System.out.println("workload_id  " + workload_id);
			}
		}
	}
	...
	private void writeFile() {
		...
		String bm = index == 0 ? comboBox_3.getSelectedIndex() + "" : "2";
		...
		try {
			...
			String command_name = eagleTreeExecutable + executableName + " " + srcLocation + " " + resultsLocation + " " + workload_id;
	...
	private void initialize() {
		...
		JLabel lblReadDeadline = new JLabel("- Read deadline (\u03BCs)");
		...
		JLabel lblWriteDeadline = new JLabel("- Write deadline (\u03BCs)");
		...
		comboBox_3.setModel(new DefaultComboBoxModel<String>(new String[] {"Shortest queue (SQ)", "SQ + Locality"}));
		...
		list_1.setModel(new AbstractListModel<String>() {
			String[] values = new String[] {"Don't split reads", "Split reads", "Deadlines", "File System", "File System & Tagging", "User Defined"};
			public int getSize() {
		...
		lblWorkload = new JLabel("Workload");
		...
		scrollPane_9 = new JScrollPane();
		    ...
		    list_6 = new JList<String>();
		    list_6.setEnabled(true);
		    ...
		    list_6.setModel(new AbstractListModel<String>() {
		      String[] values = new String[] {"Random reads & writes", "File System"};
		      public int getSize() {
		        return values.length;
		      }
		      public String getElementAt(int index) {
